/*
 * This file ("SourceValuation.java") is part of the molecular-project by Louis.
...
public interface SourceValuation {

    List<AbstractPluginContainer> evaluate(@Nonnull PluginSource source, @Nonnull DataWatcher watcher, @Nonnull PluginContainerFactory factory);
