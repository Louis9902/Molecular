/*
 * This file ("SPacketPayload.java") is part of the molecular-project by Louis.
...
public class SPacketPayload extends PacketPayload<NetworkHandlerClientWork> {

    @PacketConstructor
    private SPacketPayload() {
    }

    public SPacketPayload(@Nonnull String channel, @Nonnull PacketBuf payload) {
