/*
 * This file ("CPacketTransmit.java") is part of the molecular-project by Louis.
...
public class CPacketTransmit implements Packet<NetworkHandlerServerWork> {

    private String resource;
    private PacketBuf payload;

    @PacketConstructor
    private CPacketTransmit() {
    }

    public CPacketTransmit(@Nonnull String resource, @Nonnull PacketBuf payload) {
    ...
    public void notifyHandler(@Nonnull NetworkHandlerServerWork handler, @Nonnull NetworkChannel channel) {
        handler.processTransmit(this, channel);
    }
