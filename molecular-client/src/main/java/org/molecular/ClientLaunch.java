/*
 * This file ("ClientLaunch.java") is part of the molecular-project by Louis.
...
public class ClientLaunch {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (options.has(VERSION)) {
            final Package pack = ClientLaunch.class.getPackage();
        ...
        new ClientApplication(directory, address).startup();
    }
}
