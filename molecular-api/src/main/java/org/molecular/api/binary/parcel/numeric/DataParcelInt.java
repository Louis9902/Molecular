/*
 * This file ("DataParcelInt.java") is part of the molecular-project by Louis.
...
public class DataParcelInt extends BaseDataParcel<Integer> {

    @APIInternal
    public DataParcelInt(@Nonnull DataInput input) throws IOException {
        super(input);
    }

    public DataParcelInt(@Nonnull String name, @Nonnull Integer data) {
        super(name, data);
    }
