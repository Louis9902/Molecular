/*
 * This file ("DataParcelFloat.java") is part of the molecular-project by Louis.
...
public class DataParcelFloat extends BaseDataParcel<Float> {

    @APIInternal
    public DataParcelFloat(@Nonnull DataInput input) throws IOException {
        super(input);
    }

    public DataParcelFloat(@Nonnull String name, @Nonnull Float data) {
        super(name, data);
    }
