/*
 * This file ("DataParcelShort.java") is part of the molecular-project by Louis.
...
public class DataParcelShort extends BaseDataParcel<Short> {

    @APIInternal
    public DataParcelShort(@Nonnull DataInput input) throws IOException {
        super(input);
    }

    public DataParcelShort(@Nonnull String name, @Nonnull Short data) {
        super(name, data);
    }
