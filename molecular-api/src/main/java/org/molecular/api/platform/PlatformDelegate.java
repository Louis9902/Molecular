/*
 * This file ("PlatformDelegate.java") is part of the molecular-project by Louis.
...
public interface PlatformDelegate {
    ...
    PacketPayload<?> newPacketPayload(@Nonnull String channel, @Nonnull PacketBuf payload);
