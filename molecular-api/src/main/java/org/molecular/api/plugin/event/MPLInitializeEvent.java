/*
 * This file ("MPLInitializeEvent.java") is part of the molecular-project by Louis.
...
public final class MPLInitializeEvent implements MPLTransmitEvent {
    ...
    public PluginPhase getPhase() {
        return PluginPhase.INITIALIZED;
    }
}
